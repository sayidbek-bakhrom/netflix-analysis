...
-- What were top 10 tv shows according to IMDB score? 
SELECT title, 
type, 
imdb_score
FROM shows_movies.titles
...
-- What were the top three most common genres?
SELECT t.genres, 
...
-- Average IMDB score for leading of actors/actresses in movies or shows 
SELECT c.name AS actor_actress, 
